...
// `short` is what the progress rail shows so four labels still fit on a phone;
// `title` is the fuller heading used on the accordion itself.
const CHECKOUT_STEPS = [
  { id: 1, title: 'Cart', short: 'Cart', hint: 'Review your spices' },
...
// Delivery promise shown across the summary + confirmation screens.
...
function Cart({ cart, updateCartQty, removeFromCart, clearCart, navigateTo, onOrderPlaced }) {
  ...
  // Bring the newly opened step under the sticky header instead of leaving the
  // user mid-page. Skipped on first render so landing on /cart does not jump.
  useEffect(() => {
...
Please confirm my order.`
  ...
  if (placedOrder) {
    ...
    return (
      <div className="cart-page section doodle-host">
        <SpiceDoodleLayer variant="page" doodles={['cinnamon', 'starAnise', 'cardamom']} />
  ...
  const renderStepHeader = (step) => {
    ...
    const isDone = step.id < maxStepReached && !isActive;
    ...
    <div className="cart-page section doodle-host">
      ...
      <div className="container">
        ...
        <div className="cart-layout-grid">
          {/* Left: stepped checkout accordion */}
          <div className="cart-left-col">
            <div className="checkout-steps">

              {/* ------------------------------------------- Step 1 — Cart */}
              <section className="checkout-step" id="checkout-step-1">
                {renderStepHeader(CHECKOUT_STEPS[0])}
                {activeStep === 1 && (
                  <div className="checkout-step-body" id="checkout-panel-1">
                    ...
                    <div className="checkout-step-actions">
                      <button type="button" className="btn btn-secondary" onClick={() => navigateTo('shop')}>
                        ← Add More Spices
                      </button>
              ...
              <section className="checkout-step" id="checkout-step-2">
                ...
                {activeStep === 2 && (
                  <div className="checkout-step-body" id="checkout-panel-2">
                    ...
                    <div className="checkout-step-actions">
                      <button type="button" className="btn btn-secondary" onClick={() => openStep(1)}>← Back to Cart</button>
                      <button type="button" className="btn btn-primary checkout-cta" onClick={handleContinue}>
                        {CONTINUE_LABEL[2]}
                      </button>
                    </div>
              ...
              <section className="checkout-step" id="checkout-step-3">
                ...
                {activeStep === 3 && (
                  <div className="checkout-step-body" id="checkout-panel-3">
                    ...
                    <div className="checkout-step-actions">
                      <button type="button" className="btn btn-secondary" onClick={() => openStep(2)}>← Back to Address</button>
                      <button type="button" className="btn btn-primary checkout-cta" onClick={handleContinue}>
                        {CONTINUE_LABEL[3]}
                      </button>
                    </div>
              ...
              <section className="checkout-step" id="checkout-step-4">
                ...
                {activeStep === 4 && (
                  <div className="checkout-step-body" id="checkout-panel-4">
                    ...
                    <div className="checkout-step-actions">
                      <button type="button" className="btn btn-secondary" onClick={() => openStep(3)}>← Back to Summary</button>
                      <button
